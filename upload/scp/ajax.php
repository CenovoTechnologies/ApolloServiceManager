...
$dispatcher = patterns('',
    ...
    url('^/tickets/', patterns('ajax.tickets.php:TicketsAjaxAPI',
        url_get('^(?P<tid>\d+)/calculatePriority/(?P<impact>\d+)/(?P<urgency>\d+)$', 'calculatePriority'),
        url_get('^(?P<tid>\d+)/filterServices/(?P<serviceType>\d+)$', 'filterServices'),
        url_get('^(?P<tid>\d+)/filterCategories/(?P<service>\d+)$', 'filterCategories'),
        url_get('^(?P<tid>\d+)/filterSubCategories/(?P<category>\d+)$', 'filterSubCategories'),
