...
class DatabaseExporter {
    ...
    var $tables = array(CONFIG_TABLE, SYSLOG_TABLE, FILE_TABLE,
        ...
        SERVICE_SUB_CAT_TABLE, GROUP_TABLE, RESOLUTION_CODE_TABLE,
        STAFF_DEPT_TABLE, TEAM_TABLE, TEAM_MEMBER_TABLE, FAQ_TABLE,
        FAQ_TOPIC_TABLE, FAQ_CATEGORY_TABLE, DRAFT_TABLE,
        CANNED_TABLE, TICKET_TABLE, ATTACHMENT_TABLE, CRON_SETTINGS_TABLE,
        ...
        TIMEZONE_TABLE, SESSION_TABLE, PAGE_TABLE, AUTO_CLOSURE_TABLE,
