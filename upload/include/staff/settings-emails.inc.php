...
<table class="table table-condensed" border="0" cellspacing="0" cellpadding="2">
    <thead>
        <tr class="table-heading">
            <th colspan="2">
                <?php echo __('Note that some of the global settings can be overwritten at department/email level.');?>
            </th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td class="required"><?php echo __('Default Template Set'); ?>:</td>
            <td>
                <select name="default_template_id" class="form-control-sm">
        ...
        <tr>
            <td class="required"><?php echo __('Default System Email');?>:</td>
            <td>
                <select name="default_email_id" class="form-control-sm">
        ...
        <tr>
            <td class="required"><?php echo __('Default Alert Email');?>:</td>
            <td>
                <select name="alert_email_id" class="form-control-sm">
        ...
        <tr>
            <td class="required"><?php echo __("Admin's Email Address");?>:</td>
            <td>
                <input type="text" class="form-control-sm" size=40 name="admin_email" value="<?php echo $config['admin_email']; ?>">
                    &nbsp;<font class="error">*&nbsp;<?php echo $errors['admin_email']; ?></font>
                <i class="help-tip icon-question-sign" href="#admins_email_address"></i>
            </td>
        </tr>
        <tr>
            <td class="required"><?php echo __("Verify Email Addresses");?>:</td>
            <td>
        ...
        <tr class="table-heading"><th colspan=2><?php echo __('Incoming Emails'); ?>:</th>
        <tr>
        ...
        <tr>
            <td><?php echo __('Strip Quoted Reply');?>:</td>
            <td>
        ...
        <tr>
            <td><?php echo __('Reply Separator Tag');?>:</td>
            <td><input type="text" class="form-control-sm" name="reply_separator" value="<?php echo $config['reply_separator']; ?>">
                &nbsp;<font class="error">&nbsp;<?php echo $errors['reply_separator']; ?></font>&nbsp;<i class="help-tip icon-question-sign" href="#reply_separator_tag"></i>
            </td>
        </tr>
        <tr>
            <td><?php echo __('Emailed Tickets Priority'); ?>:</td>
            <td>
        ...
        <tr>
            <td><?php echo __('Accept All Emails'); ?>:</td>
        ...
        <tr>
            <td><?php echo __('Accept Email Collaborators'); ?>:</td>
        ...
        <tr class="table-heading"><th colspan=2><?php echo __('Outgoing Email');?>: <?php echo __('Default email only applies to outgoing emails without SMTP setting.');?></th></tr>
        <tr><td><?php echo __('Default MTA'); ?>:</td>
            <td>
                <select name="default_smtp_id" class="form-control-sm">
