...
<div class="col-sm-12 col-md-12">
    <form method="get" action="templates.php?">
        ...
        <div style="padding-bottom:3px;" class="required faded"><?php echo __('Email Subject and Body'); ?>:</div>
        <div id="toolbar"></div>
        <div id="save" style="padding-top:5px;">
            <input type="text" name="subject" class="form-control" size="65" value="<?php echo $info['subject']; ?>"
